...
export default function CourseCard({ user, course }: CourseCardProps) {
  ...
  const isFavorite = getMyFavoritesQuery.data?.data?.find(
    (favorite) => favorite.courseId === course.id,
  );
  ...
  return (
    ...
    >
      ...
      <div className="py-2">
        <h3
          className="text-md mb-2 overflow-hidden font-semibold text-gray-900"
          style={{
            display: "-webkit-box",
            WebkitLineClamp: 2,
        ...
        {course.shortDescription && (
          <p
            className="mb-3 overflow-hidden text-xs text-gray-600"
            style={{
              display: "-webkit-box",
              WebkitLineClamp: 2,
              WebkitBoxOrient: "vertical",
            ...
            {course.discountPrice && course.discountPrice < course.price ? (
              <>
                ...
                <div className="flex items-center gap-2">
                  <span className="rounded bg-red-50 px-1.5 py-0.5 text-xs font-bold text-red-500">
